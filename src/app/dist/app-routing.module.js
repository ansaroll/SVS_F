...
var routes = [
    {
        path: '',
        loadChildren: function () { return Promise.resolve().then(function () { return require('./public/public.module'); }).then(function (m) { return m.PublicModule; }); }
    },
    {
        path: 'auth',
    ...
    {
        path: 'doctorant',
        loadChildren: function () { return Promise.resolve().then(function () { return require('./doctorant/doctorant.module'); }).then(function (m) { return m.DoctorantModule; }); },
        canActivate: [auth_guard_1.AuthGuard]
    },
];
