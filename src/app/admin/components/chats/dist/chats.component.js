...
var ChatsComponent = /** @class */ (function () {
    ...
    ChatsComponent.prototype.onSendMessage = function () {
        var _this = this;
        this.messageService.addMessage(__assign(__assign({}, this.messageForm.value), { expId: this.userIdConnected, isAdmin: true, expName: this.userNameConnected || 'Admin' })).subscribe({
            next: function () {
                _this.getMessages();
